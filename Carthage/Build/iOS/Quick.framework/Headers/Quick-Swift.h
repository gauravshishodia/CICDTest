...
/// }
///
/// \endcode\param cls The QuickSpec class for which to retrieve the root example group.
///
///
/// returns:
/// The root example group for the class.
- (ExampleGroup * _Nonnull)rootExampleGroupForSpecClass:(Class _Nonnull)cls SWIFT_WARN_UNUSED_RESULT;
...
- (NSArray<Example *> * _Nonnull)examples:(Class _Nonnull)specClass SWIFT_WARN_UNUSED_RESULT;
- (NSArray<Example *> * _Nonnull)examplesForSpecClass:(Class _Nonnull)specClass SWIFT_WARN_UNUSED_RESULT;
